...
module.exports = function () {
	...
	* */
	...
	/* simply return lowercase string from input */
	_helpers.toLowerCase = function(arg, options) {
		return arg.toLowerCase();
	}

	/* special helper to navigate another page with specified hash */
	_helpers.menuUrl = function(hashSlug, options) {
    return ('/menu&' + hashSlug.toLowerCase());
	}
